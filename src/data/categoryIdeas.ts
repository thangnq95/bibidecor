...
const studyPage: any = {
  ...
  cards: [
    card({
      ...
      titleVi: 'Góc học tập cute',
      titleEn: 'Cute study corner',
...
const deskPage: any = {
  ...
  hero: {
    ...
    badge: t('⭐ 33 ý tưởng đang chờ bạn khám phá', '⭐ 33 ideas waiting for you'),
    image: '/assets/bookshelf.jpg',
  },
  filters: [
    chip('all', '☁️', 'Tất cả', 'All'),
  ...
  cards: [
    card({
      id: 'desk-grid-pink-cute',
      slug: 'ban-lam-viec-hong-pastel-cute',
      image: '/assets/ban-lam-viec-hong-pastel-cute.jpg',
      titleVi: 'Góc làm việc hồng pastel cute',
      titleEn: 'Cute pastel pink work corner',
      descriptionVi: 'Kệ màn hình trắng, lót bàn phím hồng và phụ kiện nhỏ xinh cho bàn làm việc.',
      descriptionEn: 'A white monitor stand, pink desk mat, and cute accents for a soft work desk.',
      tagsVi: ['Dễ thương', 'Hồng pastel'],
      tagsEn: ['Cute', 'Pastel pink'],
      budgetVi: 'Khoảng 2.089.121đ',
      budgetEn: 'Around 2,089,121 VND',
      countVi: '10 món cần mua',
      countEn: '10 items needed',
      relatedSlug: 'ban-lam-viec-hong-pastel-cute',
    }),
    card({
      id: 'desk-grid-1',
...
const explorePage: any = {
  ...
  cards: [shelfPage.featured, bedroomPage.cards[1], studyPage.cards[1], deskPage.cards[0]],
  bottomCta: bedroomPage.bottomCta,
};
